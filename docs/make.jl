...
DocTestMeta = quote
    using Tidier, TidierStrings, DataFrames, Chain, Statistics
end
DocMeta.setdocmeta!(TidierStrings,
    :DocTestSetup,
    DocTestMeta;
    recursive=true)
makedocs(
...
deploydocs(; repo="https://github.com/TidierOrg/TidierStrings.jl", push_preview=true,
